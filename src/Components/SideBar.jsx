...
const SideBar = () => {
    ...
    return (
        ...
        <div className={`flex flex-col justify-center items-center z-1 text-black transition-all duration-300 ease-in-out ${toggle ? 'w-18' : 'w-76'
            }`} >
            {(toggle) ?
                <div className='h-5'>
                ...
                </div> : <div className='flex flex-col gap-10 ml-20 justify-start items-start w-60'>
